// =====================================================================================================================
//
//  File:       RestoreServerParametersCommand.MacCommand.swift
//  Project:    Swiftfire
//
//  Version:    0.9.14
//
...
// History
//
// v0.9.14 - Initial release (replaces part of MacDef.swift)
// =====================================================================================================================
...
extension RestoreServerParametersCommand: MacCommand {
    ...
    func execute() {
        ...
        for parm in ServerParameterName.all {
            toConsole?.transfer(ReadServerParameterReply(parameter: parm, value: parameters.stringValue(for: parm)))
        }
    }
}

// =====================================================================================================================
//
//  File:       ReadServerTelemetryCommand.MacCommand.swift
//  Project:    Swiftfire
//
//  Version:    0.9.14
//
...
extension ReadServerTelemetryCommand: MacCommand {
    ...
    func execute() {
        ...
        case .serverVersion:
            ...
            let reply = ReadServerTelemetryReply(item: telemetryName, value: parameters.version)
            toConsole?.transfer(reply)
        }
    }
}

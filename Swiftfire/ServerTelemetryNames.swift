...
//         - Renamed from ServerTelemetryItem
...
enum ServerTelemetryName: String {
    ...
    static let all: Array<ServerTelemetryName> = [.serverVersion, .serverStatus, .nofAcceptWaitsForConnectionObject, .nofAcceptedHttpRequests, .nofHttp400Replies, .nofHttp500Replies, .nofHttp502Replies]
}

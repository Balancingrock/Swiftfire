// =====================================================================================================================
//
//  File:       ReadDomainTelemetryReply.swift
//  Project:    Swiftfire
//
//  Version:    0.9.4
//
...
private let REPLY_NAME = "ReadDomainTelemetryReply"
private let DOMAIN_NAME = "Domain"
private let TELEMETRY = "Telemetry"


final class ReadDomainTelemetryReply {
    ...
    var json: VJson {
        ...
        j[REPLY_NAME].addChild(domainTelemetry.json(TELEMETRY))
        return j
    }
    ...
    init?(json: VJson?) {
        ...
        guard let jname = (json|REPLY_NAME|DOMAIN_NAME)?.stringValue else { return nil }
        guard let jtelemetryJson = (json|REPLY_NAME|TELEMETRY) else { return nil }

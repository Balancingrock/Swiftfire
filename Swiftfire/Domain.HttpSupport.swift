...
extension Domain {
    ...
    func resourcePathFor(headerUrl: String?) -> String? {
        
        guard let url = headerUrl else { return nil }
                
        return (root as NSString).stringByAppendingPathComponent(url)
    }
}

...
/// Resets the telemetry for a specific domain.

public final class ResetDomainTelemetryCommand: MacMessage {
    ...
    /// The name of the domain that must be reset.
    ...
    ///
    /// - Parameters:
    ///   - domainName: The name of the domain that must be reset.

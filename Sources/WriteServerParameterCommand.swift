...
final class WriteServerParameterCommand: MacMessage {
    ...
    init?(json: VJson?) {
        ...
        guard let jparameter = ServerParameterName(rawValue: jparameterName) else { return nil }
    ...
    static var networkLogTarget = SwifterLog.NetworkTarget("","")
}

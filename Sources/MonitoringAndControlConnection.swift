...
final class MonitoringAndControlConnection: SwifterSockets.Connection {
    ...
    init(for type: SwifterSockets.InterfaceAccess, remoteAddress address: String) {
        ...
        commandFactories.append(SwiftfireQuitCommand.factory)
        commandFactories.append(HttpServerRunCommand.factory)
        commandFactories.append(HttpServerStopCommand.factory)
        commandFactories.append(HttpsServerRunCommand.factory)
        commandFactories.append(HttpsServerStopCommand.factory)

...
// =====================================================================================================================
//
/// Creates a (text) link that will post the key/value combination when clicked. Note the appearance of the link depends on the presence of the CSS in the given example.
//
//
// Signature:
// ----------
...
func postingLink(target: String, text: String, keyValuePairs: Dictionary<String, String>) -> String {
...
func function_postingLink(_ args: Function.Arguments, _ info: inout Function.Info, _ environment: inout Function.Environment) -> Data? {

...
final class ServerTelemetry {
    
    
    /// The version number of the server & console software
    
    let serverVersion = NamedStringValue(
        name: "ServerVersion",
    ...
    let httpServerStatus = NamedStringValue(
    ...
    let httpsServerStatus = NamedStringValue(
    ...
    let nofAcceptWaitsForConnectionObject = NamedIntValue(
    ...
    let nofAcceptedHttpRequests = NamedIntValue(
    ...
    let nofHttp400Replies = NamedIntValue(
    ...
    let nofHttp500Replies = NamedIntValue(
    ...
    let all: Array<NamedValueProtocol>

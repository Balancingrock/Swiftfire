...
final class Blacklist {
    ...
    private(set) var list: Dictionary<String, BlacklistAction> = [:]
...
extension Blacklist {
    ...
    @discardableResult
    func save(to file: URL) -> Result<Bool> {
    ...
    func restore(from file: URL) -> Result<Bool> {
...
extension Blacklist {
    ...
    func action(for address: String) -> BlacklistAction? {
        return list[address]
    }
    ...
    func add(_ address: String, action: BlacklistAction) {
        list[address] = action
    }
    ...
    @discardableResult
    func update(action: BlacklistAction, for address: String) -> Bool {
        if list[address] != nil {
            list[address] = action
            return true
        } else {

...
private let REPLY_NAME = "ReadStatisticsReply"
private let STATISTICS = "Statistics"


/// Contains the statistics information.

public final class ReadStatisticsReply: MacMessage {
    ...
    public var json: VJson {
        let json = VJson()
        json[REPLY_NAME][STATISTICS] &= stats
        return json
    }
    ...
    /// The statistics as a VJson hierarchy

    public var stats: VJson
    
    
    /// Creates a new command.
    ///
    /// - Parameters:
    ///   - statistics: A VJson hierarchy with the statistics information.

    public init(statistics: VJson) {

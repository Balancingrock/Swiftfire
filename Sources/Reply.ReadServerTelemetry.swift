...
// History
//
// 0.10.6 - Changed ServerTelemetryName to ServerTelemetry.Name
// 0.9.17 - Header update
// 0.9.15 - General update and switch to frameworks
// 0.9.14 - Updated Command & Reply structure
// 0.9.13 - Upgraded to Swift 3 beta
...
/// Returns the value of a server telemetry item.

public final class ReadServerTelemetryReply: MacMessage {
    ...
    /// The name of the server telemetry item.
    ...
    public init(item: NamedValueProtocol) {
        payload = VJson()
        payload["Name"] &= item.name
        payload["Value"] &= item.stringValue
    }
}

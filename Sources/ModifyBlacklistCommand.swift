// =====================================================================================================================
//
//  File:       ModifyBlacklistCommand.swift
//  Project:    Swiftfire
//
//  Version:    0.9.15
//
...
private let COMMAND_NAME = "ModifyBlacklistCommand"
...
final class ModifyBlacklistCommand: MacMessage {
    ...
    init(source: String, address: String, action: String, remove: Bool) {
        self.source = source

...
private let REPLY_NAME = "ReadDomainsReply"


/// This reply contains a copy of all domains.

public final class ReadDomainsReply: MacMessage {
    ...
    public init?(json: VJson?) {
        ...
        guard let payload = json|REPLY_NAME else { return nil }
    ...
    public let domains: VJson

    
    /// Create a new reply
    
    public init(domains: Domains) {
        self.domains = domains.json
    }
}

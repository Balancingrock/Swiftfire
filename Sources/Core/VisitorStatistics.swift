...
public struct Visit {
    ...
    public let responseCode: Response.Code
    ...
    public func writeToTableFields(portal: Portal) {
...
final class VisitorStatistics {
    ...
    public init?(directory: URL?, timeForDailyLogRestart: WallclockTime, maxRowCount: Int) {
    ...
    public func append(_ visit: Visit) {
